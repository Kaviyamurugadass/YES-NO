...
export default function App() {
  return (
    <div className="min-h-screen bg-gray-200 flex flex-col items-center">
      <MyHeader />
      <div className="absolute top-[45%] md:top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="relative w-[280px] h-[280px] md:w-[400px] md:h-[400px] flex justify-center items-center mt-16 md:mt-36">
          <button 
            onClick={click}
